...
if(KALYPSSO_CORE_USE_MPI)
  ...
  if(MPI_CXX_FOUND)
    ...
    if(OMPI_INFO)
      ...
      if((_output MATCHES "smcuda") OR (KALYPSSO_CORE_USE_MPI_CUDA_AWARE_ENFORCED))
    ...
    message(
      WARNING "Not compiling with MPI. Suppress this warning with -DKALYPSSO_CORE_USE_MPI=OFF")
    set(KALYPSSO_CORE_USE_MPI OFF)
  endif(MPI_CXX_FOUND)
