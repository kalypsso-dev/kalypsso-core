 ...
 */
#ifndef KALYPSSO_TEST_FILLOUTSIDE_H_
#define KALYPSSO_TEST_FILLOUTSIDE_H_
...
public:
   ...
   *
   */
  FillOutsideCellFunctor(ConfigMap const &        config_map,
...
// we have to declare here, and instantiate in FillOutside.cpp all class for a particular desired
// init functor.
extern template class FillOutsideCellFunctor<2, kalypsso::DefaultDevice, InitFunc1>;
extern template class FillOutsideCellFunctor<3, kalypsso::DefaultDevice, InitFunc1>;
extern template class FillOutsideCellFunctor<2, kalypsso::DefaultDevice, InitFunc2>;
extern template class FillOutsideCellFunctor<3, kalypsso::DefaultDevice, InitFunc2>;

} // namespace test

} // namespace kalypsso

#endif // KALYPSSO_TEST_FILLOUTSIDE_H_
