...
test_morton_2d()
{
  ...
  std::cout << "splitBy3<2>(" << ix << "=" << std::bitset<4>(ix) << ")=" << ix_s << "="
            << std::bitset<12>(ix_s) << "\n";
  std::cout << "splitBy3<2>(" << iy << "=" << std::bitset<4>(iy) << ")=" << iy_s << "="
            << std::bitset<12>(iy_s) << "\n";
  ...
  std::cout << "key = " << key << " ==> extracted x,y = " << morton_extract_bits<2, IX>(key) << ","
...
test_morton_3d()
{
  ...
  std::cout << "splitBy3<3>(" << ix << "=" << std::bitset<4>(ix) << ")=" << ix_s << "="
            << std::bitset<12>(ix_s) << "\n";
  std::cout << "splitBy3<3>(" << iy << "=" << std::bitset<4>(iy) << ")=" << iy_s << "="
            << std::bitset<12>(iy_s) << "\n";
  std::cout << "splitBy3<3>(" << iz << "=" << std::bitset<4>(iz) << ")=" << iz_s << "="
            << std::bitset<12>(iz_s) << "\n";
  ...
  std::cout << "Reverse morton key:\n";
  std::cout << "key = " << key << " ==> extracted x,y,z = " << morton_extract_bits<3, IX>(key)
            << "," << morton_extract_bits<3, IY>(key) << "," << morton_extract_bits<3, IZ>(key)
            << "\n";
...
main(int argc, char * argv[])
{
  ...
  kalypsso::test_morton_2d();
  kalypsso::test_morton_3d();
