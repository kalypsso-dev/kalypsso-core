...
static int
refine_pillow_fn(p8est_t * p8est, p4est_topidx_t which_tree, p8est_quadrant_t * quadrant)
{
...
static int
refine_pillow_sphere_fn(p8est_t * p8est, p4est_topidx_t which_tree, p8est_quadrant_t * quadrant)
{
  p8est_geometry_t * geom = (p8est_geometry_t *)p8est->user_pointer;
