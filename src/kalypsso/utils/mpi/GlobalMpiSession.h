 ...
 *
 */
#ifndef KALYPSSO_UTILS_MPI_GLOBAL_MPI_SESSION_H_
#define KALYPSSO_UTILS_MPI_GLOBAL_MPI_SESSION_H_

#include <kalypsso/utils/mpi/mpi_utils.h> // for macro CHECK_MPI_ERR
 ...
 * - if MPI is already initialized, e.g. kalypsso used as library in a thrird party application,
...
private:
  ...
  //! When kalypsso is used as library, MPI_Init/MPI_Finalize is called elsewhere, so MPI is not
...
#endif // KALYPSSO_UTILS_MPI_GLOBAL_MPI_SESSION_H_
