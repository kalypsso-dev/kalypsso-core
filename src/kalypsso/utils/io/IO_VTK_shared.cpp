...
#include <kalypsso/core/enums.h>      // for ComponentIndex3D (IX,IY,IZ)
#include <kalypsso/core/misc_utils.h> // for get_current_date
...
write_vtu_header(std::ostream & outFile, ConfigMap & config_map)
{
  ...
  bool outputVtkAscii = config_map.getBool("output", "outputVtkAscii", false);
  bool outputVtkAppended = config_map.getBool("output", "outputVtkAppended", false);
  bool outputVtkBinary = config_map.getBool("output", "outputVtkBinary", false);
  bool outputDateAndTime = config_map.getBool("output", "outputDateAndTime", false);
  ...
  // print data and time
  outFile << "<!-- \n";
  outFile << "# vtk DataFile Version 3.0" << '\n' << "#This file was generated by kalypsso";
                  ...
                  const int                          iStep)
{
  ...
  const int nbvar = static_cast<int>(varNames.size());
