 ...
 */
#ifndef KALYPSSO_CORE_KEY_TYPE_H
#define KALYPSSO_CORE_KEY_TYPE_H
 ...
 * different
 *
 * \note Not used when AMR is done with p4est
 */
...
KOKKOS_INLINE_FUNCTION
static uint64_t
encode_level_tree(int level, int treeId = 0)
{
...
#endif // KALYPSSO_CORE_KEY_TYPE_H
